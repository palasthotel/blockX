	...
	function enqueueGutenberg( array $blocks, Dependencies $dependencies, array $containers, array $composedBlocks ) {
		...
		wp_localize_script(
			...
			[
				...
				"i18n"     => [
					"btn_apply_changes" => __( "Apply changes", 'blockx' ),
					"term_select_any"   => __( "– Any –", 'blockx' ),
					"widget_tax_query"  => [
						"btn_add_taxonomy"       => _x( "Add taxonomy", "tax query widget", 'blockx' ),
						"btn_delete_taxonomy"    => _x( "Delete", "tax query widget", 'blockx' ),
						"label_taxonomy"         => _x( "Taxonomy", "tax query widget", 'blockx' ),
						"label_add_terms"        => _x( "Add terms", "tax query widget", 'blockx' ),
						"label_operator"         => _x( "Operator", "tax query widget", 'blockx' ),
						"toggle_AND_description" => _x( "All taxonomy conditions.", "tax query widget", 'blockx' ),
						"toggle_OR_description"  => _x( "One of the taxonomy conditions.", "tax query widget", 'blockx' ),
					],
					"widget_media"      => [
						"no_permission" => _x( 'You do not have permission to use media.', 'media widget', 'blockx' ),
						"not_found"     => _x( '❓ Media not found.', 'media widget', 'blockx' ),
					],
				],
