    ...
    Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__["registerBlockType"])(id, _objectSpread(_objectSpread({}, registerBlockTypeArgs), {}, {
      ...
      edit: function edit(props) {
        var isSelected = props.isSelected,
            ...
            attributes = props.attributes; // for local state changes 
        ...
        var changeLocalState = function changeLocalState(key, value) {
          return setLocalChangeState(function (_state) {
...
var ServerSideRenderQueue = function ServerSideRenderQueue(_ref2) {
  ...
  var html = Object(_hooks_use_store__WEBPACK_IMPORTED_MODULE_4__["useSSR"])(block, content);
  var isRequesting = Object(_hooks_use_store__WEBPACK_IMPORTED_MODULE_4__["useIsRequestingBlock"])(block, content);
  var isInRenderQueue = Object(_hooks_use_store__WEBPACK_IMPORTED_MODULE_4__["useIsInRenderQueue"])(block, content);
...
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _hooks_use_translation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../hooks/use-translation */ "./src/script/gutenberg/hooks/use-translation.js");
...
/* harmony import */ var _hooks_use_context__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../hooks/use-context */ "./src/script/gutenberg/hooks/use-context.js");
...
var Panels = function Panels(_ref) {
  ...
  var _useTranslation = Object(_hooks_use_translation__WEBPACK_IMPORTED_MODULE_4__["useTranslation"])(),
      btn_apply_changes = _useTranslation.btn_apply_changes;

  var _useBlock = Object(_hooks_use_context__WEBPACK_IMPORTED_MODULE_6__["useBlock"])(),
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, panels.map(function (panel, panelIndex) {
    ...
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_content_structure__WEBPACK_IMPORTED_MODULE_5__["default"], {
  ...
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["PanelBody"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Button"], {
    isSecondary: true,
...
/* harmony import */ var _ToggleWidget_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ToggleWidget.js */ "./src/script/gutenberg/components/widgets/ToggleWidget.js");
/* harmony import */ var _HiddenWidget_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./HiddenWidget.js */ "./src/script/gutenberg/components/widgets/HiddenWidget.js");
/* harmony import */ var _DividerWidget_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./DividerWidget.js */ "./src/script/gutenberg/components/widgets/DividerWidget.js");
/* harmony import */ var _ReadonlyWidget_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ReadonlyWidget.js */ "./src/script/gutenberg/components/widgets/ReadonlyWidget.js");
...
var widgets = {
  ...
  toggle: _ToggleWidget_js__WEBPACK_IMPORTED_MODULE_6__["default"],
  ...
  hidden: _HiddenWidget_js__WEBPACK_IMPORTED_MODULE_7__["default"],
  divider: _DividerWidget_js__WEBPACK_IMPORTED_MODULE_8__["default"],
  readonly: _ReadonlyWidget_js__WEBPACK_IMPORTED_MODULE_9__["default"]
};
...
var getHash = function getHash(blockId, blockContent) {
  return btoa("".concat(blockId, "-").concat(JSON.stringify(blockContent)));
};
...
var actions = {
  addToQueue: function addToQueue(blockId, blockContent) {
    var block = {
      id: blockId,
...
var store = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_4__["registerStore"])(STORE_NAME, {
  ...
  // ------------------------------------------------------
  selectors: {
    isRequesting: function isRequesting(state, blockId, blockContent) {
      // is requesting something
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(blockId) === ( true ? "undefined" : undefined) || _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(blockContent) === ( true ? "undefined" : undefined)) {
        return state.isRequesting;
      } // is requesting specific block configuration


      return state.isRequesting && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(state.queue[getHash(blockId, blockContent)]) !== ( true ? "undefined" : undefined);
    },
    isInQueue: function isInQueue(state, blockId, blockContent) {
      return _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(state.queue[getHash(blockId, blockContent)]) !== ( true ? "undefined" : undefined);
    },
    ...
    getBlock: function getBlock(state, blockId, blockContent) {
...
var useIsInRenderQueue = function useIsInRenderQueue(blockId, blockContent) {
  return useSelectStore(function (state) {
    return state.isInQueue(blockId, blockContent);
  }, [blockId, blockContent]);
};
var useIsRequestingBlock = function useIsRequestingBlock(blockId, blockContent) {
  return useSelectStore(function (state) {
    return state.isRequesting(blockId, blockContent);
  }, [blockId, blockContent]);
};
var useSSR = function useSSR(blockId, blockContent) {
  var html = useSelectStore(function (state) {
    return state.getBlock(blockId, blockContent);
  }, [blockId, blockContent]);
